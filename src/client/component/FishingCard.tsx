...
import { View, Text, Dimensions, TouchableOpacity,FlatList, StyleSheet, ActivityIndicator } from "react-native";
  ...
  const fetchNearbyActivities = async () => {
    ...
    try {
      ...
      const res = await axios.post(
        "http://192.168.18.29:3000/api/fetchFishing",
  ...
  fetchNearbyActivities();
    ...
    return (
        <View style={{ flex: 1 }}>
            {activities.length > 0 ? (
                <>
                 <Text style={styles.info}>Hiking NearBy</Text>
            ...
            <Text style={styles.info}>No fishing activities found nearby.</Text>
