...
import { View, Text, Dimensions, TouchableOpacity,FlatList,ActivityIndicator, StyleSheet } from "react-native";
  ...
  const fetchNearbyActivities = async () => {
    ...
    try {
      ...
      const res = await axios.post(
        "http://192.168.18.29:3000/api/fetchPasses",
  ...
  fetchNearbyActivities();
    ...
    return (
        <View style={{ flex: 1 }}>
            {activities.length > 0 ? (
                <>
                <Text style={styles.info}>Passes NearBy</Text>
            <FlatList
                data={activities}
            ...
            />
                    ...
                    <Text style={styles.info}>No passes activities found nearby.</Text>
