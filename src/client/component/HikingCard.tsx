...
import { View, Text, Dimensions, TouchableOpacity,FlatList, StyleSheet, Image, ActivityIndicator } from "react-native";
  ...
  const fetchNearbyActivities = async () => {
    ...
    try {
      ...
      const res = await axios.post(
        "http://192.168.18.29:3000/api/fetchHiking",
    ...
    if (loading) {
      ...
      return (
        <View style={{ flex: 1 }}>
            ...
            <Text style={styles.info}>No hiking activities found nearby.</Text>  
            )}
